def player_turn(n):
    i = int(input(f'{players[0][n].upper()}, укажите номер строки для поля, в которое хоитите поставить \
{players[1][n]}.\n'))
...
print('для поля, в которое вы хотите поставить крестик или нолик.')
